...
let largeMap = document.getElementById("large-map");
let closeButton = document.getElementById("close-button");
map.addEventListener('click', function handleClick(_event) {
    console.log(map.getElementsByTagName("button"));
    const element = document.getElementById("center-panel");
    map.className = "large-map";
    map.innerText = "This is a map";
